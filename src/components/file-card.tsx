...
export function FileCard({ file }: { file: IDocument }) {
  ...
  const nameArr = file.filepath.split("/");
  const name = file.name || nameArr[nameArr.length - 1];
    ...
    >
      ...
      <div className="flex justify-between items-end">
        ...
        <button
          ...
          className="p-1 rounded-full text-blue-600 hover:text-blue-800 hover:bg-gray-100"
        >
